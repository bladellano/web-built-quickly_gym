...
## Criar uma Landing Page para Personal Trainer Online
...
Crie uma landing page profissional e altamente persuasiva para a venda de serviços de personal trainer online, onde o profissional atende remotamente seus alunos, oferecendo treinos personalizados e acompanhamento de dieta. A página deve ser visualmente impactante, transmitir autoridade e gerar desejo imediato de contratação.

### Estilo

Para o estilo visual, utilize cores escuras com toques vibrantes, criando um ambiente acolhedor e moderno. A estética deve ser limpa, responsiva, com animações sutis e de alto impacto, transmitindo energia, saúde e transformação.

### Tom

Persuasivo, direto e envolvente, transmitindo a emoção de conquistar resultados reais com acompanhamento profissional personalizado.

### Público-alvo

Pessoas que buscam melhorar a saúde, emagrecer, ganhar massa muscular, ter mais disposição e qualidade de vida, e que desejam praticidade e flexibilidade com acompanhamento remoto.

### Estrutura sugerida

1. Menu de navegação fixo no topo com rolagem suave, contendo links para: Sobre o Serviço, Benefícios, FAQ e Contrate Agora.
2. Seção principal (hero): destaque do serviço de personal trainer online com uma imagem inspiradora, slogan chamativo como "Transforme seu corpo sem sair de casa" e botão de CTA “Comece Agora”.
3. Seção de detalhes: benefícios do acompanhamento remoto, descrição clara dos diferenciais, qualidade do suporte, exemplos de resultados e lista de modalidades atendidas (emagrecimento, hipertrofia, saúde, etc.).
4. Seção de exclusividade/urgência: destaque de promoções limitadas, como “Contrate hoje e ganhe avaliação gratuita!” e chamada de ação para gerar urgência.
5. FAQ com respostas curtas para dúvidas comuns (como funciona o atendimento, formas de pagamento, cancelamento, plataformas utilizadas). Use respostas genéricas para serem alteradas depois.
6. Seção de contratação: botão de destaque com preço (ex: R$ 149,90/mês), opções de pagamento (cartão de crédito, débito) e garantia de satisfação.
7. Rodapé com links para redes sociais do personal trainer, como Instagram e Facebook.
10. Widget flutuante do WhatsApp no canto inferior direito, sempre visível, redirecionando para o WhatsApp Web com número configurável conforme o nicho/cliente.
8. Página extra na rota "/obrigado" informando que a contratação foi recebida e que o cliente receberá um e-mail de confirmação.
